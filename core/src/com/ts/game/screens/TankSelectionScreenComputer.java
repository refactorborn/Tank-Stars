...
public class TankSelectionScreenComputer extends ScreenAdapter implements SelectionScreen {
    private Stage stage;
    ...
    private boolean player1Check = false;
    public TankSelectionScreenComputer(final ts game) {
        //Initiating
        this.game = game;
    ...
    public void createTable2(){
        ...
        final Label player1 = new Label("Player", game.resource.getSkin());
        ...
        slctBtn.addListener(new InputListener() {
            ...
            public boolean touchDown(InputEvent event, float x, float y, int pointer, int button) {
                game.resource.getBtnClickAudio().play();
                if(!player1Check) {
                    handleInput(player1, new Label(tankNames.get(current), game.resource.getSkin()));
                    if(player1Check){
                ...
                if(player1Check){
                    game.metadata.set(1, String.valueOf((int) (Math.random() * 3)));
                    try {
                        game.gameMode = 1;
        ...
        backBtn.addListener(new InputListener() {
            ...
            public boolean touchDown(InputEvent event, float x, float y, int pointer, int button) {
                game.resource.getBtnClickAudio().play();
                if(!player1Check) game.setScreen(new MainMenu(game));
